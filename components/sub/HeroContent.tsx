...
const HeroContent = () => {
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="flex flex-col gap-6 sm:flex-row items-center justify-center px-8 sm:px-20 mt-40 w-full  z-[20]"
    >
      <div className="h-full w-full flex flex-col sm:gap-5 justify-center m-auto text-start">
        <motion.div
        ...
        <motion.div
          ...
          className="flex flex-col gap-6 mt-6 text-2xl sm:text-6xl font-bold text-white max-2-[600px] w-auto h-auto"
        >
          <span>
            I&apos;m
            ...
            <span className="sm:text-5xl sm:leading-[4rem]">
              <Type />
            </span>
          </span>
        </motion.div>
